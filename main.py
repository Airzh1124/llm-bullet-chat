...
def main() -> int:
    ...
    overlay = DanmakuOverlay(
        ...
        outline_color=config.danmaku_outline_color,
        outline_width=config.danmaku_outline_width,
        text_background_alpha=config.danmaku_text_background_alpha,
        mode=config.danmaku_mode,
        ...
        panel_left_ratio=config.danmaku_panel_left_ratio,
        panel_top_ratio=config.danmaku_panel_top_ratio,
        panel_width_ratio=config.danmaku_panel_width_ratio,
        panel_height_ratio=config.danmaku_panel_height_ratio,
        panel_background_alpha=config.danmaku_panel_background_alpha,
        panel_scroll_speed=config.danmaku_panel_scroll_speed,
        panel_line_gap=config.danmaku_panel_line_gap,
        panel_max_items=config.danmaku_panel_max_items,
